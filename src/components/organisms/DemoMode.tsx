...
export default function DemoMode() {
  ...
  return (
    <div className="sticky bottom-0 left-0 w-full h-12 z-50 text-sm text-center md:text-md lg:text-lg bg-slate-800 text-white flex justify-center items-center">
      👋 Mode démo activé :{" "}
      {!isCheckoutPage

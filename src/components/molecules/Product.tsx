    ...
    <div className="relative hover:scale-105 transition-all group">
      ...
      <Link
        ...
        className={cn(
          ...
          "rounded-full border border-input hover:bg-green-900/95 hover:text-white px-8 uppercase bottom-0 absolute bg-white left-1/2 transform -translate-x-1/2 group-hover:animate-showup invisible group-hover:bottom-8 group-hover:visible animate-hide"
        )}
      >
        Add to cart
      </Link>
